...
ss.new_action('move',[130.0,70.0])
ss.new_action('move',[130.0,80.0])
ss.new_action('move',[140.0,90.0])
ss.new_action('move',[150.0,90.0])
ss.new_action('move',[160.0,90.0])
ss.new_action('move',[170.0,90.0])
ss.new_action('move',[180.0,90.0])
